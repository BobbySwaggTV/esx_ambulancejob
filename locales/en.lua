Locales['en'] = {
  ...
  ['garage_storing'] = 'attempting to remove the vehicle, make sure no players are around it.',
  ...
  ['combatlog_message'] = 'you have been force-respawned because you have previously left the server when dead.',
  -- Revive
